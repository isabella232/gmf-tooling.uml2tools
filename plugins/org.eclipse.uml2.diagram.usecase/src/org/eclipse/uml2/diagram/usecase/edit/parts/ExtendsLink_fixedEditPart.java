...
public class ExtendsLink_fixedEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new UMLParserProvider.HintAdapter(UMLElementTypes.Extend_4002, getParserElement(), parserHint);
	 ...
	 * @generated
	 */
	public class ExtendsLink_fixed extends WrapLabel {
