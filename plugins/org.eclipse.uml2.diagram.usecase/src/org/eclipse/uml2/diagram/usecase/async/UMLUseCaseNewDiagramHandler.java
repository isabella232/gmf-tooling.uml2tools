 ...
 * @generated
 */
public class UMLUseCaseNewDiagramHandler extends NewDiagramHandlerBase {
	...
	protected Wizard getNewSemiSyncDiagramWizard(Package diagramRoot, List<Element> selectedElements) {
		return new UMLUseCaseFixedElementsWizard(getDiagramFileURI(diagramRoot), diagramRoot, selectedElements.toArray(new Element[selectedElements.size()]), getEditingDomain());
	}
	...
	protected Element getValidElement(Object object) {
		...
		if (NewDiagramPropertyTester.isUMLUseCaseElement(element)) {
			return element;
		}
		return null;
	}
