...
public class AssociationSourceMultiplicityEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Association_4004, getParserElement(),
					UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.usecase.edit.parts.AssociationSourceMultiplicityEditPart.VISUAL_ID));
		}
		return parser;
	}
