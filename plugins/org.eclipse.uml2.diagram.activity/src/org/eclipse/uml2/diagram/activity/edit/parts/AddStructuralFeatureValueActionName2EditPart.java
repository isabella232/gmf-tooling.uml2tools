 ...
 * @generated
 */
public class AddStructuralFeatureValueActionName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public AddStructuralFeatureValueActionName2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new UMLParserProvider.HintAdapter(UMLElementTypes.AddStructuralFeatureValueAction_3023, getParserElement(), parserHint);
