...
public class ActivityPartition_ConditionalNodeCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.getConditionalNodeConditionalNodeCompartment_7020SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.getConditionalNodeConditionalNodeCompartment_7020SemanticChildren((View) getHost().getModel());
