...
public class ActivityPartition_CallOperationActionStereotypeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.CallOperationAction_3075, getParserElement(),
					UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.activity.edit.parts.ActivityPartition_CallOperationActionStereotypeEditPart.VISUAL_ID));
		}
		return parser;
	}
