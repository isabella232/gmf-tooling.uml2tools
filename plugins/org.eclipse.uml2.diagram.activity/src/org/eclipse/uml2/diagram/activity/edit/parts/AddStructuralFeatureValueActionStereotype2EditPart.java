...
public class AddStructuralFeatureValueActionStereotype2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public AddStructuralFeatureValueActionStereotype2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.AddStructuralFeatureValueAction_3023, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.AddStructuralFeatureValueActionStereotype2EditPart.VISUAL_ID));
		}
		return parser;
	}
