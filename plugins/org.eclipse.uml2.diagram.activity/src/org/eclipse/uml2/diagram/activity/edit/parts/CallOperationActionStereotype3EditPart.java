...
public class CallOperationActionStereotype3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CallOperationActionStereotype3EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.CallOperationAction_3075, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.CallOperationActionStereotype3EditPart.VISUAL_ID));
		}
		return parser;
	}
