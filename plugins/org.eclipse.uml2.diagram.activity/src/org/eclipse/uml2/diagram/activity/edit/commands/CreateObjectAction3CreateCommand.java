 ...
 * @generated
 */
public class CreateObjectAction3CreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public CreateObjectAction3CreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreationGen() {
		...
		if (newElement != null) {
			...
			UMLElementTypes.Initializers.CreateObjectAction_3072.init(newElement);
		}
		return newElement;
	}
