...
public class DataStoreNodeStereotype3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DataStoreNodeStereotype3EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.DataStoreNode_3065, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.DataStoreNodeStereotype3EditPart.VISUAL_ID));
		}
		return parser;
	}
