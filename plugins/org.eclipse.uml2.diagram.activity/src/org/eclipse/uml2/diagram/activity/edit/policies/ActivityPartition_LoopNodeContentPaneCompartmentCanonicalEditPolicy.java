...
public class ActivityPartition_LoopNodeContentPaneCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.getLoopNodeLoopNodeContentPaneCompartment_7017SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.getLoopNodeLoopNodeContentPaneCompartment_7017SemanticChildren((View) getHost().getModel());
