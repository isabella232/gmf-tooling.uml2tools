...
import org.eclipse.uml2.diagram.activity.edit.policies.Constraint2CanonicalEditPolicy;
import org.eclipse.uml2.diagram.activity.edit.policies.Constraint2ItemSemanticEditPolicy;
...
public class Constraint2EditPart extends ShapeNodeEditPart implements PrimaryShapeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new Constraint2CanonicalEditPolicy());
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == UMLElementTypes.LiteralString_3051) {
				return getChildBySemanticHint(UMLVisualIDRegistry.getType(ConstraintPostconditionEditPart.VISUAL_ID));
			}
		}
