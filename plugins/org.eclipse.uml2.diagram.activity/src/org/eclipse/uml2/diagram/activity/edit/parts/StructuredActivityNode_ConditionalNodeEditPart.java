...
public class StructuredActivityNode_ConditionalNodeEditPart extends ShapeNodeEditPart implements PrimaryShapeEditPart {
	...
	private List<? extends IUpdaterLinkDescriptor> getConditionalNode_3092ContainedLinks() {
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateUnspecifiedTypeRequest) {
			...
			if (types.contains(UMLElementTypes.StructuredActivityNode_3009)) {
				return getChildBySemanticHint(UMLVisualIDRegistry.getType(ConditionalNodeConditionalNodeCompartmentEditPart.VISUAL_ID));
			}
