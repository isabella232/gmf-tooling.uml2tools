 ...
 * @generated
 */
public class DataStoreNodeOrdering3EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.activity.edit.parts.DataStoreNodeOrdering3EditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public DataStoreNodeOrdering3EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new UMLParserProvider.HintAdapter(UMLElementTypes.DataStoreNode_3065, getParserElement(), parserHint);
