...
public class AddStructuralFeatureValueAction3EditPart extends AbstractBorderedShapeEditPart implements PrimaryShapeEditPart {
	...
	protected void addSemanticListeners() {
		...
		for (UMLLinkDescriptor next : getAddStructuralFeatureValueAction_3073ContainedLinks()) {
	...
	private List<UMLLinkDescriptor> getAddStructuralFeatureValueAction_3073ContainedLinks() {
