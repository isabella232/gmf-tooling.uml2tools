...
public class DataStoreNode2ViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index, boolean persisted) {
		if (semanticHint == null) {
			semanticHint = UMLVisualIDRegistry.getType(DataStoreNode2EditPart.VISUAL_ID);
		...
		getViewService().createNode(semanticAdapter, view, UMLVisualIDRegistry.getType(DataStoreNodeName3EditPart.VISUAL_ID), ViewUtil.APPEND, true, getPreferencesHint());
		getViewService().createNode(semanticAdapter, view, UMLVisualIDRegistry.getType(DataStoreNodeName4EditPart.VISUAL_ID), ViewUtil.APPEND, true, getPreferencesHint());
	}
}
