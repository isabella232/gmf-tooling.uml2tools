...
public class ActivityPartition_StructuredActivityNode_StructuredActivityNodeContentPaneCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.getStructuredActivityNodeStructuredActivityContentPaneCompartment_7018SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.getStructuredActivityNodeStructuredActivityContentPaneCompartment_7018SemanticChildren((View) getHost().getModel());
