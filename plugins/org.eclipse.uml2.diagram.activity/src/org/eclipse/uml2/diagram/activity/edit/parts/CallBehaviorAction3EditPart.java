...
import org.eclipse.uml2.diagram.activity.edit.policies.CallBehaviorAction3CanonicalEditPolicy;
...
public class CallBehaviorAction3EditPart extends AbstractBorderedShapeEditPart implements PrimaryShapeEditPart {
	 ...
	 * @generated
	 */
	public CallBehaviorAction3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new CallBehaviorAction3CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CallBehaviorActionName3EditPart) {
			((CallBehaviorActionName3EditPart) childEditPart).setLabel(getPrimaryShape().getFigureActionCallBehaviorFigure_name());
			return true;
		}
		if (childEditPart instanceof CallBehaviorActionStereotype3EditPart) {
			((CallBehaviorActionStereotype3EditPart) childEditPart).setLabel(getPrimaryShape().getFigureActionCallBehaviorFigure_stereo());
			return true;
		}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(CallBehaviorActionName3EditPart.VISUAL_ID));
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.eclipse.uml2.diagram.activity.edit.parts.CallBehaviorAction3EditPart) {
			types.add(UMLElementTypes.ControlFlow_4001);
		}
