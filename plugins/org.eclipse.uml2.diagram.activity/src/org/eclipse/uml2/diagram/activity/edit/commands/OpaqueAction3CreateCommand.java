 ...
 * @generated
 */
public class OpaqueAction3CreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public OpaqueAction3CreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreationGen() {
		...
		if (newElement != null) {
			...
			UMLElementTypes.Initializers.OpaqueAction_3067.init(newElement);
		}
		return newElement;
	}
