...
import org.eclipse.uml2.diagram.activity.edit.policies.AddStructuralFeatureValueAction2CanonicalEditPolicy;
import org.eclipse.uml2.diagram.activity.edit.policies.AddStructuralFeatureValueAction2ItemSemanticEditPolicy;
...
public class AddStructuralFeatureValueAction2EditPart extends AbstractBorderedShapeEditPart implements PrimaryShapeEditPart {
	 ...
	 * @generated
	 */
	public AddStructuralFeatureValueAction2EditPart(View view) {
		super(view);
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AddStructuralFeatureValueActionName2EditPart) {
			((AddStructuralFeatureValueActionName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureActionBaseFigure_name());
			return true;
		}
		if (childEditPart instanceof AddStructuralFeatureValueActionStereotype2EditPart) {
			((AddStructuralFeatureValueActionStereotype2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureActionBaseFigure_stereo());
			return true;
		}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(AddStructuralFeatureValueActionName2EditPart.VISUAL_ID));
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.eclipse.uml2.diagram.activity.edit.parts.AddStructuralFeatureValueAction2EditPart) {
			types.add(UMLElementTypes.ControlFlow_4001);
		}
