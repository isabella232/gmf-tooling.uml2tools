...
public class StructuredActivityNode_InitialNodeEditPart extends AbstractBorderedShapeEditPart implements PrimaryShapeEditPart {
	...
	protected IFigure createNodeShape() {
		return primaryShape = new ActivityInitialFigure();
	}
	...
	*/
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof InitialNodeName2EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(InitialNodeName2EditPart.VISUAL_ID));
	}
