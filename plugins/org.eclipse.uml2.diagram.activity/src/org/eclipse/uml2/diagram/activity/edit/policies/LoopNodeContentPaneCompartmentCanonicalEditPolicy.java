...
public class LoopNodeContentPaneCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.getLoopNodeLoopNodeContentPaneCompartment_7015SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.getLoopNodeLoopNodeContentPaneCompartment_7015SemanticChildren((View) getHost().getModel());
