...
import org.eclipse.uml2.diagram.activity.edit.policies.AcceptEventAction5ItemSemanticEditPolicy;
...
public class AcceptEventAction5EditPart extends ShapeNodeEditPart implements PrimaryShapeEditPart {
	 ...
	 * @generated
	 */
	public AcceptEventAction5EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new AcceptEventAction5ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AcceptEventActionName5EditPart) {
			((AcceptEventActionName5EditPart) childEditPart).setLabel(getPrimaryShape().getFigureAcceptEventActionFigure_name());
			return true;
		}
		if (childEditPart instanceof AcceptEventActionStereotype5EditPart) {
			((AcceptEventActionStereotype5EditPart) childEditPart).setLabel(getPrimaryShape().getFigureAcceptEventActionFigure_stereo());
			return true;
		}
		return false;
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.eclipse.uml2.diagram.activity.edit.parts.AcceptEventAction5EditPart) {
			types.add(UMLElementTypes.ControlFlow_4001);
		}
