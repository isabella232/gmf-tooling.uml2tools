 ...
 * @generated
 */
public class ActivityFinalNodeName2EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.activity.edit.parts.ActivityFinalNodeName2EditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public ActivityFinalNodeName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.ActivityFinalNode_3014, getParserElement(),
					UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.activity.edit.parts.ActivityFinalNodeName2EditPart.VISUAL_ID));
		}
		return parser;
	}
