 ...
 * @generated
 */
public class JoinNodeName2EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.activity.edit.parts.JoinNodeName2EditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public JoinNodeName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.JoinNode_3022, getParserElement(),
					UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.activity.edit.parts.JoinNodeName2EditPart.VISUAL_ID));
		}
		return parser;
	}
