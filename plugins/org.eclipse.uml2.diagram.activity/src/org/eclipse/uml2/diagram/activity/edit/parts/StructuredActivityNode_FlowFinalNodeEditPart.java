...
public class StructuredActivityNode_FlowFinalNodeEditPart extends AbstractBorderedShapeEditPart implements PrimaryShapeEditPart {
	...
	protected IFigure createNodeShape() {
		return primaryShape = new FlowFinalFigure();
	}
	...
	*/
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof FlowFinalNodeName2EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(FlowFinalNodeName2EditPart.VISUAL_ID));
	}
