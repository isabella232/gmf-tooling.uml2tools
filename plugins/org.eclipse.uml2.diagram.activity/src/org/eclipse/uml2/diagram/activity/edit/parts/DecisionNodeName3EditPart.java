 ...
 * @generated
 */
public class DecisionNodeName3EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.activity.edit.parts.DecisionNodeName3EditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public DecisionNodeName3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.DecisionNode_3062, getParserElement(),
					UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.activity.edit.parts.DecisionNodeName3EditPart.VISUAL_ID));
		}
		return parser;
	}
