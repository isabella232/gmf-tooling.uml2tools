...
public class ForkNodeEditPart extends AbstractBorderedShapeEditPart implements PrimaryShapeEditPart {
	...
	*/
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof ForkNodeNameEditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(ForkNodeNameEditPart.VISUAL_ID));
	}
