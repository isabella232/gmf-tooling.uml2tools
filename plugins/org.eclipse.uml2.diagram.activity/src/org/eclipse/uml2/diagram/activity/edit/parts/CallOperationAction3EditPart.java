...
import org.eclipse.uml2.diagram.activity.edit.policies.CallOperationAction3CanonicalEditPolicy;
...
public class CallOperationAction3EditPart extends AbstractBorderedShapeEditPart implements PrimaryShapeEditPart {
	 ...
	 * @generated
	 */
	public CallOperationAction3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new CallOperationAction3ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new CallOperationAction3CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CallOperationActionName3EditPart) {
			((CallOperationActionName3EditPart) childEditPart).setLabel(getPrimaryShape().getFigureActionBaseFigure_name());
			return true;
		}
		if (childEditPart instanceof CallOperationActionStereotype3EditPart) {
			((CallOperationActionStereotype3EditPart) childEditPart).setLabel(getPrimaryShape().getFigureActionBaseFigure_stereo());
			return true;
		}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(CallOperationActionName3EditPart.VISUAL_ID));
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.eclipse.uml2.diagram.activity.edit.parts.CallOperationAction3EditPart) {
			types.add(UMLElementTypes.ControlFlow_4001);
		}
