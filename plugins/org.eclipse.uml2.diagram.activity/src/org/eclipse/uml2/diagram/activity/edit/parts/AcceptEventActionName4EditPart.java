 ...
 * @generated
 */
public class AcceptEventActionName4EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.activity.edit.parts.AcceptEventActionName4EditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public AcceptEventActionName4EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new UMLParserProvider.HintAdapter(UMLElementTypes.AcceptEventAction_3013, getParserElement(), parserHint);
