 ...
 * @generated
 */
public class StructuredActivityNode3CreateCommand extends CreateElementCommand {
	...
	protected EObject doDefaultElementCreation() {
		StructuredActivityNode newElement = (StructuredActivityNode) super.doDefaultElementCreation();
		if (newElement != null) {
