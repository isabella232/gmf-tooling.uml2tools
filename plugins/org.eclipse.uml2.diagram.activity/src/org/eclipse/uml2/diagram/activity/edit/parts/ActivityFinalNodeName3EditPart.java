 ...
 * @generated
 */
public class ActivityFinalNodeName3EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.activity.edit.parts.ActivityFinalNodeName3EditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public ActivityFinalNodeName3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.ActivityFinalNode_3061, getParserElement(),
					UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.activity.edit.parts.ActivityFinalNodeName3EditPart.VISUAL_ID));
		}
		return parser;
	}
