...
public class ConstraintContributionItemProvider extends AbstractContributionItemProvider implements IProvider {
	...
	protected IAction createAction(String actionId, IWorkbenchPartDescriptor partDescriptor) {
		...
		if (TurnIntoConstraint2Action.ACTION_ID.equals(actionId)) {
			return new TurnIntoConstraint2Action(workbenchPage, actionId);
		}
	 ...
	 * @generated
	 */
	public static final String MENU_LABEL = Messages.ConstraintContributionItemProvider_menu;
	 ...
	 * @generated
	 */
	public static final String GROUP_LABEL = Messages.ConstraintContributionItemProvider_group;
}
