...
public class AddStructuralFeatureValueAction_value_InputPinEditPart extends BorderedBorderItemEditPart implements PrimaryShapeEditPart {
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof AddStructuralFeatureValueAction_value_InputPinNameEditPart) {
			IBorderItemLocator locator = new UnrestrictedOutsideBorderItemLocator(getMainFigure());
			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
			return;
		}
		if (borderItemEditPart instanceof AddStructuralFeatureValueAction_value_InputPinOrderingEditPart) {
			IBorderItemLocator locator = new UnrestrictedOutsideBorderItemLocator(getMainFigure());
			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
			return;
		}
