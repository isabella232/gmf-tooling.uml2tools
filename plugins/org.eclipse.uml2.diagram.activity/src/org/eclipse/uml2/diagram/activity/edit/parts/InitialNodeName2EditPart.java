 ...
 * @generated
 */
public class InitialNodeName2EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.activity.edit.parts.InitialNodeName2EditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public InitialNodeName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.InitialNode_3093, getParserElement(),
					UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.activity.edit.parts.InitialNodeName2EditPart.VISUAL_ID));
		}
		return parser;
	}
