...
public class ActivityPartition_ActivityFinalNodeEditPart extends AbstractBorderedShapeEditPart implements PrimaryShapeEditPart {
	...
	*/
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof ActivityFinalNodeName3EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(ActivityFinalNodeName3EditPart.VISUAL_ID));
	}
