...
public class OpaqueActionStereotype3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public OpaqueActionStereotype3EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.OpaqueAction_3067, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.OpaqueActionStereotype3EditPart.VISUAL_ID));
		}
		return parser;
	}
