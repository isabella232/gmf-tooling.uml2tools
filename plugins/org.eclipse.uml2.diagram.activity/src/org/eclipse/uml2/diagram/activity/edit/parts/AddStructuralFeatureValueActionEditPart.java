...
public class AddStructuralFeatureValueActionEditPart extends AbstractBorderedShapeEditPart implements PrimaryShapeEditPart {
	...
	protected void addSemanticListeners() {
		...
		for (UMLLinkDescriptor next : getAddStructuralFeatureValueAction_3043ContainedLinks()) {
	...
	private List<UMLLinkDescriptor> getAddStructuralFeatureValueAction_3043ContainedLinks() {
