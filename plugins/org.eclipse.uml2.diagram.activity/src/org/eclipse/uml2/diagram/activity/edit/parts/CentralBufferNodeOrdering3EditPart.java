 ...
 * @generated
 */
public class CentralBufferNodeOrdering3EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.activity.edit.parts.CentralBufferNodeOrdering3EditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public CentralBufferNodeOrdering3EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new UMLParserProvider.HintAdapter(UMLElementTypes.CentralBufferNode_3066, getParserElement(), parserHint);
