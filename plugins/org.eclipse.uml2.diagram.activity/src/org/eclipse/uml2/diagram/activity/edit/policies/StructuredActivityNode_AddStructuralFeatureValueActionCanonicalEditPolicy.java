...
public class StructuredActivityNode_AddStructuralFeatureValueActionCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.getAddStructuralFeatureValueAction_3023SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		int visualID = UMLVisualIDRegistry.getVisualID(view);
		return visualID == AddStructuralFeatureValueAction_insertAt_InputPinEditPart.VISUAL_ID || visualID == AddStructuralFeatureValueAction_value_InputPinEditPart.VISUAL_ID
				|| visualID == AddStructuralFeatureValueAction_object_InputPinEditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.getAddStructuralFeatureValueAction_3023SemanticChildren((View) getHost().getModel());
