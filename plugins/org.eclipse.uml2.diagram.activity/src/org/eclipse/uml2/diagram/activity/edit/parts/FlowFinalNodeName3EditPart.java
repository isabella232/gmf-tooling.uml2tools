 ...
 * @generated
 */
public class FlowFinalNodeName3EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.activity.edit.parts.FlowFinalNodeName3EditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public FlowFinalNodeName3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.FlowFinalNode_3068, getParserElement(),
					UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.activity.edit.parts.FlowFinalNodeName3EditPart.VISUAL_ID));
		}
		return parser;
	}
