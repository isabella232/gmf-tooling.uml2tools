...
import org.eclipse.uml2.diagram.activity.edit.policies.InputPin5CanonicalEditPolicy;
...
public class InputPin5EditPart extends BorderedBorderItemEditPart implements PrimaryShapeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new InputPin5CanonicalEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof InputPinName5EditPart || borderItemEditPart instanceof InputPinOrdering5EditPart) {
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.eclipse.uml2.diagram.activity.edit.parts.InputPin5EditPart) {
			types.add(UMLElementTypes.ControlFlow_4001);
		}
