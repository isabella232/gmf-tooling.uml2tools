...
public class StructuredActivityNode3EditPart extends ShapeNodeEditPart implements PrimaryShapeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof StructuredActivityNodeStereotype3EditPart) {
			((StructuredActivityNodeStereotype3EditPart) childEditPart).setLabel(getPrimaryShape().getFigureStructuredActivityFigure_stereo());
			return true;
		}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(StructuredActivityNodeStereotype3EditPart.VISUAL_ID));
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.eclipse.uml2.diagram.activity.edit.parts.StructuredActivityNode3EditPart) {
			types.add(UMLElementTypes.ControlFlow_4001);
		}
