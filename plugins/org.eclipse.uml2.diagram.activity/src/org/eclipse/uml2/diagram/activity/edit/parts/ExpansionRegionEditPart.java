...
public class ExpansionRegionEditPart extends ShapeNodeEditPart implements PrimaryShapeEditPart {
	...
	protected IFigure createNodeShape() {
		return primaryShape = new ExpansionRegionFigure();
	}
	...
	private List<? extends IUpdaterLinkDescriptor> getExpansionRegion_3084ContainedLinks() {
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateUnspecifiedTypeRequest) {
			...
			if (types.contains(UMLElementTypes.StructuredActivityNode_3009)) {
				return getChildBySemanticHint(UMLVisualIDRegistry.getType(ExpansionRegionNodeCompartmentEditPart.VISUAL_ID));
			}
			...
			if (types.contains(UMLElementTypes.ExpansionNode_3091)) {
				return getChildBySemanticHint(UMLVisualIDRegistry.getType(ExpansionRegionNodeCompartmentEditPart.VISUAL_ID));
			}
		}
