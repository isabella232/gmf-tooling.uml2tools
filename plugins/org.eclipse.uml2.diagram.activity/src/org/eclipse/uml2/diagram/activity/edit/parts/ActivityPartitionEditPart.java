...
public class ActivityPartitionEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ActivityPartitionActivityPartition_nodesEditPart) {
			IFigure pane = getPrimaryShape().getFigureActivityPartitionFigure_body();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ActivityPartitionActivityPartition_nodesEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ActivityPartitionActivityPartition_nodesEditPart) {
			IFigure pane = getPrimaryShape().getFigureActivityPartitionFigure_body();
			pane.remove(((ActivityPartitionActivityPartition_nodesEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		...
		if (editPart instanceof ActivityPartitionActivityPartition_nodesEditPart) {
