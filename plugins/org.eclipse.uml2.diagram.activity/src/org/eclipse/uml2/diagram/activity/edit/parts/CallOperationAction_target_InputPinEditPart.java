...
import org.eclipse.uml2.diagram.activity.edit.policies.CallOperationAction_target_InputPinCanonicalEditPolicy;
import org.eclipse.uml2.diagram.activity.edit.policies.CallOperationAction_target_InputPinItemSemanticEditPolicy;
...
public class CallOperationAction_target_InputPinEditPart extends BorderedBorderItemEditPart implements PrimaryShapeEditPart {
	 ...
	 * @generated
	 */
	public CallOperationAction_target_InputPinEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new CallOperationAction_target_InputPinItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new CallOperationAction_target_InputPinCanonicalEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof CallOperationAction_target_InputPinNameEditPart || borderItemEditPart instanceof CallOperationAction_target_InputPinOrderingEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(CallOperationAction_target_InputPinNameEditPart.VISUAL_ID));
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.eclipse.uml2.diagram.activity.edit.parts.CallOperationAction_target_InputPinEditPart) {
			types.add(UMLElementTypes.ControlFlow_4001);
		}
