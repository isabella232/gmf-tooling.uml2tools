...
public class CallBehaviorAction2EditPart extends AbstractBorderedShapeEditPart implements PrimaryShapeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof CallBehaviorActionStereotype2EditPart) {
			((CallBehaviorActionStereotype2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureActionCallBehaviorFigure_stereo());
			return true;
		}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.eclipse.uml2.diagram.activity.edit.parts.CallBehaviorAction2EditPart) {
			types.add(UMLElementTypes.ControlFlow_4001);
		}
