...
import org.eclipse.uml2.diagram.activity.edit.policies.ConditionalNode2CanonicalEditPolicy;
import org.eclipse.uml2.diagram.activity.edit.policies.ConditionalNode2ItemSemanticEditPolicy;
...
public class ConditionalNode2EditPart extends ShapeNodeEditPart implements PrimaryShapeEditPart {
	 ...
	 * @generated
	 */
	public ConditionalNode2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ConditionalNode2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new ConditionalNode2CanonicalEditPolicy());
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(ConditionalNodeStereotypeEditPart.VISUAL_ID));
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.eclipse.uml2.diagram.activity.edit.parts.ConditionalNode2EditPart) {
			types.add(UMLElementTypes.ControlFlow_4001);
		}
