 ...
 * @generated
 */
public class InputPinOrdering6EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.activity.edit.parts.InputPinOrdering6EditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public InputPinOrdering6EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new UMLParserProvider.HintAdapter(UMLElementTypes.InputPin_3054, getParserElement(), parserHint);
