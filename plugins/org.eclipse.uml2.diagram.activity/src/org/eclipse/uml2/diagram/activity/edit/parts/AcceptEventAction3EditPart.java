...
public class AcceptEventAction3EditPart extends ShapeNodeEditPart implements PrimaryShapeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof AcceptEventActionStereotype2EditPart) {
			((AcceptEventActionStereotype2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureAcceptEventActionFigure_stereo());
			return true;
		}
		return false;
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.eclipse.uml2.diagram.activity.edit.parts.AcceptEventAction3EditPart) {
			types.add(UMLElementTypes.ControlFlow_4001);
		}
