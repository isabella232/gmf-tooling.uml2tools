...
import org.eclipse.uml2.diagram.activity.edit.policies.InputPin2CanonicalEditPolicy;
...
public class InputPin2EditPart extends BorderedBorderItemEditPart implements PrimaryShapeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new InputPin2CanonicalEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof InputPinName2EditPart || borderItemEditPart instanceof InputPinOrdering2EditPart) {
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.eclipse.uml2.diagram.activity.edit.parts.InputPin2EditPart) {
			types.add(UMLElementTypes.ControlFlow_4001);
		}
