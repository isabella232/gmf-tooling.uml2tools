...
import org.eclipse.uml2.diagram.activity.edit.policies.LiteralStringItemSemanticEditPolicy;
...
public class LiteralStringEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new UMLParserProvider.HintAdapter(UMLElementTypes.LiteralString_3049, getParserElement(), parserHint);
