 ...
 * @generated
 */
public class PinOrdering3EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.activity.edit.parts.PinOrdering3EditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public PinOrdering3EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider
					.getParser(UMLElementTypes.Pin_3071, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.activity.edit.parts.PinOrdering3EditPart.VISUAL_ID));
		}
		return parser;
	}
