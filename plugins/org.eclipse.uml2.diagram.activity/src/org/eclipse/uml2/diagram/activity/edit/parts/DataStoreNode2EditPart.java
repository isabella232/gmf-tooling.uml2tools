...
import org.eclipse.uml2.diagram.activity.edit.policies.DataStoreNode2CanonicalEditPolicy;
import org.eclipse.uml2.diagram.activity.edit.policies.DataStoreNode2ItemSemanticEditPolicy;
...
public class DataStoreNode2EditPart extends AbstractBorderedShapeEditPart implements PrimaryShapeEditPart {
	 ...
	 * @generated
	 */
	public DataStoreNode2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DataStoreNode2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new DataStoreNode2CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DataStoreNodeName2EditPart) {
			((DataStoreNodeName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureDataStoreFigure_name());
			return true;
		}
		if (childEditPart instanceof DataStoreNodeInState2EditPart) {
			((DataStoreNodeInState2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureDataStoreFigure_states());
			return true;
		}
		if (childEditPart instanceof DataStoreNodeStereotype2EditPart) {
			((DataStoreNodeStereotype2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureDataStoreFigure_stereo());
			return true;
		}
		return false;
	}
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof DataStoreNodeOrdering2EditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(DataStoreNodeName2EditPart.VISUAL_ID));
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.eclipse.uml2.diagram.activity.edit.parts.DataStoreNode2EditPart) {
			types.add(UMLElementTypes.ControlFlow_4001);
		}
