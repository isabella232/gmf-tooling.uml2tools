 ...
 * @generated
 */
public class CentralBufferNode3CreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public CentralBufferNode3CreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreationGen() {
		...
		if (newElement != null) {
			...
			UMLElementTypes.Initializers.CentralBufferNode_3066.init(newElement);
		}
		return newElement;
	}
