 ...
 * @generated
 */
public class CallOperationAction3CreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public CallOperationAction3CreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreationGen() {
		...
		if (newElement != null) {
			...
			UMLElementTypes.Initializers.CallOperationAction_3075.init(newElement);
		}
		return newElement;
	}
