...
public class CentralBufferNode3EditPart extends AbstractBorderedShapeEditPart implements PrimaryShapeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof CentralBufferNodeInState3EditPart) {
			((CentralBufferNodeInState3EditPart) childEditPart).setLabel(getPrimaryShape().getFigureCentralBufferFigure_states());
			return true;
		}
		if (childEditPart instanceof CentralBufferNodeStereotype3EditPart) {
			((CentralBufferNodeStereotype3EditPart) childEditPart).setLabel(getPrimaryShape().getFigureCentralBufferFigure_stereo());
			return true;
		}
		return false;
	}
