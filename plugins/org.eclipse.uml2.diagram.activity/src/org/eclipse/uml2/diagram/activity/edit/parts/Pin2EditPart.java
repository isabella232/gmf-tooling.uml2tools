...
import org.eclipse.uml2.diagram.activity.edit.policies.Pin2CanonicalEditPolicy;
import org.eclipse.uml2.diagram.activity.edit.policies.Pin2ItemSemanticEditPolicy;
...
public class Pin2EditPart extends AbstractBorderedShapeEditPart implements PrimaryShapeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PinName2EditPart) {
			((PinName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureStandalonePinFigure_name());
			return true;
		}
		if (childEditPart instanceof PinInState2EditPart) {
			((PinInState2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureStandalonePinFigure_states());
			return true;
		}
		if (childEditPart instanceof PinStereotype2EditPart) {
			((PinStereotype2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureStandalonePinFigure_stereo());
			return true;
		}
		return false;
	}
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof PinOrdering2EditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(PinName2EditPart.VISUAL_ID));
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.eclipse.uml2.diagram.activity.edit.parts.Pin2EditPart) {
			types.add(UMLElementTypes.ControlFlow_4001);
		}
