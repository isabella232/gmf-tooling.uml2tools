...
import org.eclipse.uml2.diagram.activity.edit.policies.InputPin6CanonicalEditPolicy;
import org.eclipse.uml2.diagram.activity.edit.policies.InputPin6ItemSemanticEditPolicy;
...
public class InputPin6EditPart extends AbstractBorderedShapeEditPart implements PrimaryShapeEditPart {
	 ...
	 * @generated
	 */
	public InputPin6EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new InputPin6ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new InputPin6CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof InputPinName6EditPart) {
			((InputPinName6EditPart) childEditPart).setLabel(getPrimaryShape().getFigureStandalonePinFigure_name());
			return true;
		}
		return false;
	}
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof InputPinOrdering6EditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(InputPinName6EditPart.VISUAL_ID));
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.eclipse.uml2.diagram.activity.edit.parts.InputPin6EditPart) {
			types.add(UMLElementTypes.ControlFlow_4001);
		}
