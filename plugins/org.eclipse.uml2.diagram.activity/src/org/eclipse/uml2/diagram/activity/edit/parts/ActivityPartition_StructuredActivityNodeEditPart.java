...
public class ActivityPartition_StructuredActivityNodeEditPart extends ShapeNodeEditPart implements PrimaryShapeEditPart {
	...
	private List<? extends IUpdaterLinkDescriptor> getStructuredActivityNode_3076ContainedLinks() {
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateUnspecifiedTypeRequest) {
			...
			if (types.contains(UMLElementTypes.StructuredActivityNode_3079)) {
				return getChildBySemanticHint(UMLVisualIDRegistry.getType(ActivityPartition_StructuredActivityNodeContentPaneCompartmentEditPart.VISUAL_ID));
			}
