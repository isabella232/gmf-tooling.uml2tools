...
import org.eclipse.uml2.diagram.activity.edit.policies.OutputPin6CanonicalEditPolicy;
import org.eclipse.uml2.diagram.activity.edit.policies.OutputPin6ItemSemanticEditPolicy;
...
public class OutputPin6EditPart extends BorderedBorderItemEditPart implements PrimaryShapeEditPart {
	 ...
	 * @generated
	 */
	public OutputPin6EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new OutputPin6ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new OutputPin6CanonicalEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof OutputPinName6EditPart || borderItemEditPart instanceof OutputPinOrdering6EditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(OutputPinName6EditPart.VISUAL_ID));
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.eclipse.uml2.diagram.activity.edit.parts.OutputPin6EditPart) {
			types.add(UMLElementTypes.ControlFlow_4001);
		}
