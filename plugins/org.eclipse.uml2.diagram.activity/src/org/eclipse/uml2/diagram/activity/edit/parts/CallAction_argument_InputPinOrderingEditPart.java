...
public class CallAction_argument_InputPinOrderingEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.activity.edit.parts.CallAction_argument_InputPinOrderingEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public CallAction_argument_InputPinOrderingEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.InputPin_3007, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.CallAction_argument_InputPinOrderingEditPart.VISUAL_ID));
		}
		return parser;
	}
