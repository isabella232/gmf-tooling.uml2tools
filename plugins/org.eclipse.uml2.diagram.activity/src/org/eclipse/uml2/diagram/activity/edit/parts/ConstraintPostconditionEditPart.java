 ...
 * @generated
 */
public class ConstraintPostconditionEditPart extends ListCompartmentEditPart {
	 ...
	 * @generated
	 */
	public ConstraintPostconditionEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ConstraintPostconditionItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE, new CreationEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new ConstraintPostconditionCanonicalEditPolicy());
	}
