 ...
 * @generated
 */
public class InitialNodeName3EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.activity.edit.parts.InitialNodeName3EditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public InitialNodeName3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.InitialNode_3064, getParserElement(),
					UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.activity.edit.parts.InitialNodeName3EditPart.VISUAL_ID));
		}
		return parser;
	}
