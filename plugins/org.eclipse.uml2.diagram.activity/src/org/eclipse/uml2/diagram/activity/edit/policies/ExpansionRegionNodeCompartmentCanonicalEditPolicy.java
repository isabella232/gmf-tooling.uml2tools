...
public class ExpansionRegionNodeCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.getExpansionRegionExpansionRegionNodeCompartment_7021SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.getExpansionRegionExpansionRegionNodeCompartment_7021SemanticChildren((View) getHost().getModel());
