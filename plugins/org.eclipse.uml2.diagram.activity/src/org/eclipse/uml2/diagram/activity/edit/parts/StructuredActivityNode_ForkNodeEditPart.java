...
public class StructuredActivityNode_ForkNodeEditPart extends AbstractBorderedShapeEditPart implements PrimaryShapeEditPart {
	...
	*/
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof ForkNodeName2EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(ForkNodeName2EditPart.VISUAL_ID));
	}
