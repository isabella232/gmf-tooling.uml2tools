...
public class AddStructuralFeatureValueActionCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.getAddStructuralFeatureValueAction_3043SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.getAddStructuralFeatureValueAction_3043SemanticChildren((View) getHost().getModel());
