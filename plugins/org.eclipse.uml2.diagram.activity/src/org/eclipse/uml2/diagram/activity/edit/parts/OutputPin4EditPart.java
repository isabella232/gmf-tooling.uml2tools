...
import org.eclipse.uml2.diagram.activity.edit.policies.OutputPin4CanonicalEditPolicy;
import org.eclipse.uml2.diagram.activity.edit.policies.OutputPin4ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class OutputPin4EditPart extends AbstractBorderedShapeEditPart implements PrimaryShapeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof OutputPinName4EditPart) {
			((OutputPinName4EditPart) childEditPart).setLabel(getPrimaryShape().getFigureStandalonePinFigure_name());
			return true;
		}
		return false;
	}
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof OutputPinOrdering4EditPart) {
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.eclipse.uml2.diagram.activity.edit.parts.OutputPin4EditPart) {
			types.add(UMLElementTypes.ControlFlow_4001);
		}
