 ...
 * @generated
 */
public class PinOrdering2EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.activity.edit.parts.PinOrdering2EditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public PinOrdering2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider
					.getParser(UMLElementTypes.Pin_3017, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.activity.edit.parts.PinOrdering2EditPart.VISUAL_ID));
		}
		return parser;
	}
