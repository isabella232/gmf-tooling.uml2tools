...
public class ActivityPartition_ExpansionRegionEditPart extends ShapeNodeEditPart implements PrimaryShapeEditPart {
	...
	private List<? extends IUpdaterLinkDescriptor> getExpansionRegion_3085ContainedLinks() {
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateUnspecifiedTypeRequest) {
			...
			if (types.contains(UMLElementTypes.StructuredActivityNode_3009)) {
				return getChildBySemanticHint(UMLVisualIDRegistry.getType(ActivityPartition_ExpansionRegionNodeCompartmentEditPart.VISUAL_ID));
			}
