...
public class ActivityPartition_StructuredActivityNode_StructuredActivityNodeEditPart extends ShapeNodeEditPart implements PrimaryShapeEditPart {
	...
	private List<? extends IUpdaterLinkDescriptor> getStructuredActivityNode_3079ContainedLinks() {
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateUnspecifiedTypeRequest) {
			...
			if (types.contains(UMLElementTypes.StructuredActivityNode_3079)) {
				return getChildBySemanticHint(UMLVisualIDRegistry.getType(ActivityPartition_StructuredActivityNode_StructuredActivityNodeContentPaneCompartmentEditPart.VISUAL_ID));
			}
			...
			if (types.contains(UMLElementTypes.InputPin_3080)) {
				return getChildBySemanticHint(UMLVisualIDRegistry.getType(ActivityPartition_StructuredActivityNode_StructuredActivityNodeContentPaneCompartmentEditPart.VISUAL_ID));
			}
			if (types.contains(UMLElementTypes.OutputPin_3081)) {
				return getChildBySemanticHint(UMLVisualIDRegistry.getType(ActivityPartition_StructuredActivityNode_StructuredActivityNodeContentPaneCompartmentEditPart.VISUAL_ID));
			}
		}
