...
public class ConditionalNodeEditPart extends ShapeNodeEditPart implements PrimaryShapeEditPart {
	...
	private List<? extends IUpdaterLinkDescriptor> getConditionalNode_3082ContainedLinks() {
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateUnspecifiedTypeRequest) {
			...
			if (types.contains(UMLElementTypes.StructuredActivityNode_3009)) {
				return getChildBySemanticHint(UMLVisualIDRegistry.getType(ConditionalNodeCompartmentEditPart.VISUAL_ID));
			}
