...
public class CreateObjectActionStereotype3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CreateObjectActionStereotype3EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.CreateObjectAction_3072, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.activity.edit.parts.CreateObjectActionStereotype3EditPart.VISUAL_ID));
		}
		return parser;
	}
