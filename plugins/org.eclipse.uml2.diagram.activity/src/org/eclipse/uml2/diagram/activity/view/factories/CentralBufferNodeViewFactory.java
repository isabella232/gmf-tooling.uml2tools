...
public class CentralBufferNodeViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index, boolean persisted) {
		...
		getViewService().createNode(semanticAdapter, view, UMLVisualIDRegistry.getType(CentralBufferNodeNameEditPart.VISUAL_ID), ViewUtil.APPEND, true, getPreferencesHint());
		getViewService().createNode(semanticAdapter, view, UMLVisualIDRegistry.getType(CentralBufferNodeName2EditPart.VISUAL_ID), ViewUtil.APPEND, true, getPreferencesHint());
	}
}
