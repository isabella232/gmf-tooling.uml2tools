...
public class ActivityPartition_ExpansionRegionNodeCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.getExpansionRegionExpansionRegionNodeCompartment_7022SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.getExpansionRegionExpansionRegionNodeCompartment_7022SemanticChildren((View) getHost().getModel());
