 ...
 * @generated
 */
public class MergeNodeName2EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.activity.edit.parts.MergeNodeName2EditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public MergeNodeName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.MergeNode_3063, getParserElement(),
					UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.activity.edit.parts.MergeNodeName2EditPart.VISUAL_ID));
		}
		return parser;
	}
