...
public class StructuredActivityNode_CallOperationActionCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.getCallOperationAction_3020SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		int visualID = UMLVisualIDRegistry.getVisualID(view);
		return visualID == CallAction_OutputPinEditPart.VISUAL_ID || visualID == CallAction_InputPinEditPart.VISUAL_ID || visualID == CallOperationAction_InputPinEditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.getCallOperationAction_3020SemanticChildren((View) getHost().getModel());
