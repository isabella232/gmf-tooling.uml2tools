...
public class CommunicationPathNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.CommunicationPath_4004, getParserElement(),
					UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.deploy.edit.parts.CommunicationPathNameEditPart.VISUAL_ID));
		}
		return parser;
	}
