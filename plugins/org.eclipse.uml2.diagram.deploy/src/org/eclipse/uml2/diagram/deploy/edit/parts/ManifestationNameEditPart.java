...
public class ManifestationNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Manifestation_4002, getParserElement(),
					UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.deploy.edit.parts.ManifestationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
