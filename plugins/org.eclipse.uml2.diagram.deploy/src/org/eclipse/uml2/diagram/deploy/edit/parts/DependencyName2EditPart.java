...
public class DependencyName2EditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.deploy.edit.parts.DependencyName2EditPart.VISUAL_ID), new Point(0, 20));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Dependency_4005, getParserElement(),
					UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.deploy.edit.parts.DependencyName2EditPart.VISUAL_ID));
		}
		return parser;
	}
