...
public class Artifact2EditPart extends ShapeNodeEditPart implements PrimaryShapeEditPart {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.eclipse.uml2.diagram.deploy.edit.parts.Artifact2EditPart) {
			types.add(UMLElementTypes.Manifestation_4002);
		}
	...
	private List<? extends IUpdaterLinkDescriptor> getArtifact_2006ContainedLinks() {
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateUnspecifiedTypeRequest) {
			...
			if (types.contains(UMLElementTypes.Artifact_3008)) {
				return getChildBySemanticHint(UMLVisualIDRegistry.getType(ArtifactArtifactFigure_contents3EditPart.VISUAL_ID));
			}
