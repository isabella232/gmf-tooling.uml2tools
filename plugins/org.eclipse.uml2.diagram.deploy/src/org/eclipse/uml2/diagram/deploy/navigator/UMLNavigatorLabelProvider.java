...
public class UMLNavigatorLabelProvider extends LabelProvider implements ICommonLabelProvider, ITreePathLabelProvider {
	...
	private String getExecutionEnvironment_2005Text(View view) {
		IParser parser = UMLParserProvider.getParser(UMLElementTypes.ExecutionEnvironment_2005, view.getElement() != null ? view.getElement() : view,
	...
	private String getArtifact_2006Text(View view) {
		IParser parser = UMLParserProvider.getParser(UMLElementTypes.Artifact_2006, view.getElement() != null ? view.getElement() : view,
				UMLVisualIDRegistry.getType(ArtifactFileNameEditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(view.getElement() != null ? view.getElement() : view), ParserOptions.NONE.intValue());
		} else {
	...
	private String getDeploymentSpecification_2007Text(View view) {
		IParser parser = UMLParserProvider.getParser(UMLElementTypes.DeploymentSpecification_2007, view.getElement() != null ? view.getElement() : view,
	...
	private String getElementImport_3001Text(View view) {
		IParser parser = UMLParserProvider.getParser(UMLElementTypes.ElementImport_3001, view.getElement() != null ? view.getElement() : view,
	...
	private String getArtifact_3002Text(View view) {
		IParser parser = UMLParserProvider.getParser(UMLElementTypes.Artifact_3002, view.getElement() != null ? view.getElement() : view,
				UMLVisualIDRegistry.getType(ArtifactFileName2EditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(view.getElement() != null ? view.getElement() : view), ParserOptions.NONE.intValue());
		} else {
	...
	private String getArtifact_3008Text(View view) {
		IParser parser = UMLParserProvider.getParser(UMLElementTypes.Artifact_3008, view.getElement() != null ? view.getElement() : view,
				UMLVisualIDRegistry.getType(ArtifactFileName3EditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(view.getElement() != null ? view.getElement() : view), ParserOptions.NONE.intValue());
		} else {
	...
	private String getDeploymentSpecification_3009Text(View view) {
		IParser parser = UMLParserProvider.getParser(UMLElementTypes.DeploymentSpecification_3009, view.getElement() != null ? view.getElement() : view,
				UMLVisualIDRegistry.getType(DeploymentSpecificationName2EditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(view.getElement() != null ? view.getElement() : view), ParserOptions.NONE.intValue());
		} else {
	...
	private String getExecutionEnvironment_3005Text(View view) {
		IParser parser = UMLParserProvider.getParser(UMLElementTypes.ExecutionEnvironment_3005, view.getElement() != null ? view.getElement() : view,
				UMLVisualIDRegistry.getType(ExecutionEnvironmentName2EditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(view.getElement() != null ? view.getElement() : view), ParserOptions.NONE.intValue());
		} else {
	...
	private String getDeployment_4001Text(View view) {
		IParser parser = UMLParserProvider.getParser(UMLElementTypes.Deployment_4001, view.getElement() != null ? view.getElement() : view,
				UMLVisualIDRegistry.getType(DeploymentNameEditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(view.getElement() != null ? view.getElement() : view), ParserOptions.NONE.intValue());
		} else {
	...
	private String getManifestation_4002Text(View view) {
		IParser parser = UMLParserProvider.getParser(UMLElementTypes.Manifestation_4002, view.getElement() != null ? view.getElement() : view,
	...
	private String getCommunicationPath_4004Text(View view) {
		IParser parser = UMLParserProvider.getParser(UMLElementTypes.CommunicationPath_4004, view.getElement() != null ? view.getElement() : view,
	...
	private String getDependency_4005Text(View view) {
		IParser parser = UMLParserProvider.getParser(UMLElementTypes.Dependency_4005, view.getElement() != null ? view.getElement() : view,
