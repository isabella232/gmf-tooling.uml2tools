...
public class ExecutionEnvironment2EditPart extends ShapeNodeEditPart implements PrimaryShapeEditPart {
				...
				if (understandsRequest(request)) {
					if (request instanceof CreateViewAndElementRequest) {
						...
						if (type == UMLElementTypes.Artifact_3006) {
							EditPart compartmentEditPart = getChildBySemanticHint(UMLVisualIDRegistry.getType(ExecutionEnvironmentArtifacts2EditPart.VISUAL_ID));
	...
	protected void addSemanticListeners() {
		...
		for (UMLLinkDescriptor next : getExecutionEnvironment_3005ContainedLinks()) {
	...
	private List<UMLLinkDescriptor> getExecutionEnvironment_3005ContainedLinks() {
