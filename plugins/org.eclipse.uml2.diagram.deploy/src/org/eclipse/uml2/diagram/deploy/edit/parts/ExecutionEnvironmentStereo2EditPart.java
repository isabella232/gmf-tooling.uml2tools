...
public class ExecutionEnvironmentStereo2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.ExecutionEnvironment_3005, getParserElement(),
					UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.deploy.edit.parts.ExecutionEnvironmentStereo2EditPart.VISUAL_ID));
		}
		return parser;
	}
