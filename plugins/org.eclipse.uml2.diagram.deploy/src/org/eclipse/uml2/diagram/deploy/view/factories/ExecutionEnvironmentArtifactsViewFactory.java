 ...
 * @generated
 */
public class ExecutionEnvironmentArtifactsViewFactory extends BasicNodeViewFactory {
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index, boolean persisted) {
		if (semanticHint == null) {
			semanticHint = UMLVisualIDRegistry.getType(ExecutionEnvironmentArtifactsEditPart.VISUAL_ID);
