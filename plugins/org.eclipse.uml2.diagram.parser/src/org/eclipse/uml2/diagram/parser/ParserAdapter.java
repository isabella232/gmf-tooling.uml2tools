...
public class ParserAdapter implements IParser {
	...
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (modelObject == null) {
			return new ParserEditStatus(MDTDiagramParserPlugin.getPluginID(), IParserEditStatus.UNEDITABLE, "Can not find context object");
		}
		...
		try {
			...
			return new ParserEditStatus(MDTDiagramParserPlugin.getPluginID(), IParserEditStatus.UNEDITABLE, "Invalid input: " + message);
		} finally {
