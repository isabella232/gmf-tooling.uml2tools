 ...
 * @generated
 */
public class AbstractNewMenuEntryItemProvider
	 ...
	 * @generated
	 */
	public AbstractNewMenuEntryItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		return getString("_UI_AbstractNewMenuEntry_type");
	}
	...
	protected static List<EReference> filterByContainerMetaclass(Collection<EReference> eReferences, EClass containerMetaClass, boolean containmentOnly) {
		if (containerMetaClass == null){
			return new ArrayList<EReference>(eReferences);
		}
		
		return FilterUtil.sort(//
				FilterUtil.getEReferences(//
						FilterUtil.getEStructuralFeaturesOf(eReferences, containerMetaClass), containmentOnly));
	}
