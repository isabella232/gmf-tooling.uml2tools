...
public class DataType3EditPart extends AbstractBorderedShapeEditPart implements PrimaryShapeEditPart {
				...
				if (understandsRequest(request)) {
					if (request instanceof CreateViewAndElementRequest) {
						...
						if (type == UMLElementTypes.Property_3014) {
							EditPart compartmentEditPart = getChildBySemanticHint(UMLVisualIDRegistry.getType(DataTypeAttributes2EditPart.VISUAL_ID));
							return compartmentEditPart == null ? null : compartmentEditPart.getCommand(request);
						}
						if (type == UMLElementTypes.Operation_3015) {
							EditPart compartmentEditPart = getChildBySemanticHint(UMLVisualIDRegistry.getType(DataTypeOperations2EditPart.VISUAL_ID));
							return compartmentEditPart == null ? null : compartmentEditPart.getCommand(request);
						}
					}
	...
	protected void addSemanticListeners() {
		...
		for (UMLLinkDescriptor next : getDataType_3036ContainedLinks()) {
	...
	private List<UMLLinkDescriptor> getDataType_3036ContainedLinks() {
