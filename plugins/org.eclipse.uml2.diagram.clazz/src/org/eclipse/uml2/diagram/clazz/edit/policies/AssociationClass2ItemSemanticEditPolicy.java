...
public class AssociationClass2ItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator it = allEdges.iterator(); it.hasNext();) {
			...
			EditCommandRequestWrapper editCommandRequest = new EditCommandRequestWrapper(new DestroyElementRequest(((AssociationClass2EditPart) getHost()).getEditingDomain(), req
	...
	protected Command getCreateRelationshipCommand(CreateRelationshipRequest req) {
		...
		if (UMLElementTypes.Property_4003 == req.getElementType()) {
			return req.getTarget() == null ? getCreateStartOutgoingProperty_4003Command(req) : getCreateCompleteIncomingProperty_4003Command(req);
		}
		...
		if (UMLElementTypes.InterfaceRealization_4008 == req.getElementType()) {
			return req.getTarget() == null ? getCreateStartOutgoingInterfaceRealization_4008Command(req) : null;
		}
	 ...
	 * @generated
	 */
	protected Command getCreateStartOutgoingProperty_4003Command(CreateRelationshipRequest req) {
		EObject sourceEObject = req.getSource();
		if (false == sourceEObject instanceof Association) {
			return UnexecutableCommand.INSTANCE;
		}
		Association source = (Association) sourceEObject;
		if (!UMLBaseItemSemanticEditPolicy.LinkConstraints.canCreateProperty_4003(source, null)) {
			return UnexecutableCommand.INSTANCE;
		}
		return new Command() {
		};
	 ...
	 * @generated
	 */
	protected Command getCreateStartOutgoingInterfaceRealization_4008Command(CreateRelationshipRequest req) {
		EObject sourceEObject = req.getSource();
		...
		if (!UMLBaseItemSemanticEditPolicy.LinkConstraints.canCreateInterfaceRealization_4008(container, source, null)) {
			return UnexecutableCommand.INSTANCE;
		}
		return new Command() {
		};
