 ...
 * @generated
 */
public class PackageAsFrameViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index, boolean persisted) {
		if (semanticHint == null) {
			semanticHint = UMLVisualIDRegistry.getType(PackageAsFrameEditPart.VISUAL_ID);
		...
		getViewService().createNode(eObjectAdapter, view, UMLVisualIDRegistry.getType(PackageAsFrameContentsEditPart.VISUAL_ID), ViewUtil.APPEND, true, getPreferencesHint());
	}
