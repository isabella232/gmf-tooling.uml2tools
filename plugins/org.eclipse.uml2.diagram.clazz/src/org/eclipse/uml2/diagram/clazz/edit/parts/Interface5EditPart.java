...
import org.eclipse.uml2.diagram.clazz.edit.policies.Interface5ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Interface5EditPart extends AbstractBorderedShapeEditPart implements PrimaryShapeEditPart {
	 ...
	 * @generated
	 */
	public Interface5EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Interface5ItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof InterfaceName4EditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(InterfaceName4EditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.eclipse.uml2.diagram.clazz.edit.parts.Interface5EditPart) {
			types.add(UMLElementTypes.Generalization_4001);
		}
	...
	protected void addSemanticListeners() {
		...
		for (IUpdaterNodeDescriptor next : getInterface_3043ContainedLinks()) {
	...
	private List<? extends IUpdaterLinkDescriptor> getInterface_3043ContainedLinks() {
		return UMLDiagramUpdater.getInterface_3043ContainedLinks(getNotationView());
	}
