 ...
 * @generated
 */
public class InstanceSpecification4ViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index, boolean persisted) {
		if (semanticHint == null) {
			semanticHint = UMLVisualIDRegistry.getType(InstanceSpecification4EditPart.VISUAL_ID);
		...
		getViewService().createNode(eObjectAdapter, view, UMLVisualIDRegistry.getType(Label2EditPart.VISUAL_ID), ViewUtil.APPEND, true, getPreferencesHint());
	}
