 ...
 * @generated
 */
public class Interface5CreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public Interface5CreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		ElementInitializers.getInstance().init_Interface_3043(newElement);
