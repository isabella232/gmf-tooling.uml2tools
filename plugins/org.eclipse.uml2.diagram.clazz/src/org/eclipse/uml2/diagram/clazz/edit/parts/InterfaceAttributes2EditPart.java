...
import org.eclipse.uml2.diagram.clazz.edit.policies.InterfaceAttributes2CanonicalEditPolicy;
import org.eclipse.uml2.diagram.clazz.edit.policies.InterfaceAttributes2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class InterfaceAttributes2EditPart extends ListCompartmentEditPart implements IInsertableEditPart {
	 ...
	 * @generated
	 */
	public InterfaceAttributes2EditPart(View view) {
		super(view);
	}
	...
	public String getCompartmentName() {
		return Messages.InterfaceAttributes2EditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new InterfaceAttributes2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE, new CreationEditPolicyWithCustomReparent(UMLVisualIDRegistry.TYPED_ADAPTER));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new InterfaceAttributes2CanonicalEditPolicy());
