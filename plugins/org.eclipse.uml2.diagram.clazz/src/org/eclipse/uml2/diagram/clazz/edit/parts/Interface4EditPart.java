...
import org.eclipse.uml2.diagram.clazz.edit.policies.Interface4ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Interface4EditPart extends ShapeNodeEditPart implements PrimaryShapeEditPart {
	 ...
	 * @generated
	 */
	public Interface4EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Interface4ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof InterfaceStereotype2EditPart) {
			((InterfaceStereotype2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureClassFigure_StereoLabel());
			return true;
		}
		if (childEditPart instanceof InterfaceAttributes2EditPart) {
			IFigure pane = getPrimaryShape().getFigureClassFigure_PropertiesCompartment();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((InterfaceAttributes2EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof InterfaceOperations2EditPart) {
			IFigure pane = getPrimaryShape().getFigureClassFigure_OperationsCompartment();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((InterfaceOperations2EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof InterfaceClasses2EditPart) {
			IFigure pane = getPrimaryShape().getFigureClassFigure_ClassesCompartment();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((InterfaceClasses2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof InterfaceAttributes2EditPart) {
			IFigure pane = getPrimaryShape().getFigureClassFigure_PropertiesCompartment();
			pane.remove(((InterfaceAttributes2EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof InterfaceOperations2EditPart) {
			IFigure pane = getPrimaryShape().getFigureClassFigure_OperationsCompartment();
			pane.remove(((InterfaceOperations2EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof InterfaceClasses2EditPart) {
			IFigure pane = getPrimaryShape().getFigureClassFigure_ClassesCompartment();
			pane.remove(((InterfaceClasses2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof InterfaceAttributes2EditPart) {
			return getPrimaryShape().getFigureClassFigure_PropertiesCompartment();
		}
		if (editPart instanceof InterfaceOperations2EditPart) {
			return getPrimaryShape().getFigureClassFigure_OperationsCompartment();
		}
		if (editPart instanceof InterfaceClasses2EditPart) {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.eclipse.uml2.diagram.clazz.edit.parts.Interface4EditPart) {
			types.add(UMLElementTypes.Generalization_4001);
		}
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == UMLElementTypes.Property_3028) {
				return getChildBySemanticHint(UMLVisualIDRegistry.getType(InterfaceAttributes2EditPart.VISUAL_ID));
			}
			if (type == UMLElementTypes.Operation_3029) {
				return getChildBySemanticHint(UMLVisualIDRegistry.getType(InterfaceOperations2EditPart.VISUAL_ID));
			}
			if (type == UMLElementTypes.Class_3030) {
				return getChildBySemanticHint(UMLVisualIDRegistry.getType(InterfaceClasses2EditPart.VISUAL_ID));
			}
		}
	...
	protected void addSemanticListeners() {
		...
		for (IUpdaterNodeDescriptor next : getInterface_3042ContainedLinks()) {
	...
	private List<? extends IUpdaterLinkDescriptor> getInterface_3042ContainedLinks() {
		return UMLDiagramUpdater.getInterface_3042ContainedLinks(getNotationView());
	}
