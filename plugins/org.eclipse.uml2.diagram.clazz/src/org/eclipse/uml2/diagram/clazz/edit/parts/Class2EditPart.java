...
public class Class2EditPart extends AbstractBorderedShapeEditPart implements PrimaryShapeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ClassStereotypeEditPart) {
			((ClassStereotypeEditPart) childEditPart).setLabel(getPrimaryShape().getFigureClassFigure_stereo());
			return true;
		}
	...
	protected void addSemanticListeners() {
		...
		for (UMLLinkDescriptor next : getClass_2001ContainedLinks()) {
	...
	private List<UMLLinkDescriptor> getClass_2001ContainedLinks() {
