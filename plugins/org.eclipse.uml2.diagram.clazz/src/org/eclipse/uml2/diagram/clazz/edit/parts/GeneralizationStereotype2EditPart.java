...
public class GeneralizationStereotype2EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Generalization_4011, getParserElement(),
					UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.clazz.edit.parts.GeneralizationStereotype2EditPart.VISUAL_ID));
		}
		return parser;
	}
