 ...
 * @generated
 */
public class InterfaceClassesViewFactory extends ListCompartmentViewFactory {
	...
	protected void decorateViewGen(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index, boolean persisted) {
		if (semanticHint == null) {
			semanticHint = UMLVisualIDRegistry.getType(InterfaceClassesEditPart.VISUAL_ID);
