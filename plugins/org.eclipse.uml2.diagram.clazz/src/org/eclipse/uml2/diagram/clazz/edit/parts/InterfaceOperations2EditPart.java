...
import org.eclipse.uml2.diagram.clazz.edit.policies.InterfaceOperations2CanonicalEditPolicy;
import org.eclipse.uml2.diagram.clazz.edit.policies.InterfaceOperations2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class InterfaceOperations2EditPart extends ListCompartmentEditPart implements IInsertableEditPart {
	 ...
	 * @generated
	 */
	public InterfaceOperations2EditPart(View view) {
		super(view);
	}
	...
	public String getCompartmentName() {
		return Messages.InterfaceOperations2EditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new InterfaceOperations2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE, new CreationEditPolicyWithCustomReparent(UMLVisualIDRegistry.TYPED_ADAPTER));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new InterfaceOperations2CanonicalEditPolicy());
