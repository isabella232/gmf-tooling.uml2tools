...
public class GeneralizationViewFactory extends ConnectionViewFactory {
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index, boolean persisted) {
		...
		getViewService().createNode(eObjectAdapter, view, UMLVisualIDRegistry.getType(GeneralizationStereotypeEditPart.VISUAL_ID), ViewUtil.APPEND, true, getPreferencesHint());
	}
}
