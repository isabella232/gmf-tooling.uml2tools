...
public class DependencyEditPart extends AbstractBorderedShapeEditPart implements PrimaryShapeEditPart {
	...
	protected void addSemanticListeners() {
		...
		for (IUpdaterNodeDescriptor next : getDependency_2009ContainedLinks()) {
	...
	private List<IUpdaterLinkDescriptor> getDependency_2009ContainedLinks() {
		return UMLDiagramUpdater.getDependency_2009ContainedLinks(getNotationView());
	}
