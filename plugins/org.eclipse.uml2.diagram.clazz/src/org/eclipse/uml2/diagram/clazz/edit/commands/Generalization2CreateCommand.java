...
public class Generalization2CreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		if (target != null && false == target instanceof GeneralizationSet) {
			return false;
		}
		if (getSource() == null) {
	 ...
	 * @generated
	 */
	protected void doConfigureGen(Generalization newElement, IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
