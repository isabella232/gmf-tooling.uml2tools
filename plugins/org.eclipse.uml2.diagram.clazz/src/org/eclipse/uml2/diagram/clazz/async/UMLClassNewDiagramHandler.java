 ...
 * @generated
 */
public class UMLClassNewDiagramHandler extends NewDiagramHandlerBase {
	...
	protected Wizard getNewSemiSyncDiagramWizard(Package diagramRoot, List<Element> selectedElements) {
		return new UMLClassFixedElementsWizard(getDiagramFileURI(diagramRoot), diagramRoot, selectedElements.toArray(new Element[selectedElements.size()]), getEditingDomain());
	}
	...
	protected Element getValidElement(Object object) {
		...
		if (NewDiagramPropertyTester.isUMLClassElement(element)) {
			return element;
		}
		return null;
	}
