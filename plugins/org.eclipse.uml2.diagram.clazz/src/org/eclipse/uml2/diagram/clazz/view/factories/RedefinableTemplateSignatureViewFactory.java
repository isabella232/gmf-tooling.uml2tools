...
public class RedefinableTemplateSignatureViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index, boolean persisted) {
		...
		getViewService().createNode(semanticAdapter, view, UMLVisualIDRegistry.getType(TemplateSignatureNode_signatureEditPart.VISUAL_ID), ViewUtil.APPEND, true, getPreferencesHint());
	}
}
