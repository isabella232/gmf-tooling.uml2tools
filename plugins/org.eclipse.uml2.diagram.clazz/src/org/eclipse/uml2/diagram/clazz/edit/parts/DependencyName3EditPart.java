...
public class DependencyName3EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Dependency_4002, getParserElement(),
					UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.clazz.edit.parts.DependencyName3EditPart.VISUAL_ID));
		}
		return parser;
	}
