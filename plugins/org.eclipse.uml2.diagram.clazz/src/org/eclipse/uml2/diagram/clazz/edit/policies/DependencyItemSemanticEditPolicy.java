...
public class DependencyItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator it = allEdges.iterator(); it.hasNext();) {
			...
			EditCommandRequestWrapper editCommandRequest = new EditCommandRequestWrapper(new DestroyElementRequest(((DependencyEditPart) getHost()).getEditingDomain(), req.isConfirmationRequired()),
	...
	protected Command getCreateRelationshipCommand(CreateRelationshipRequest req) {
		...
		if (UMLElementTypes.DependencySupplier_4006 == req.getElementType()) {
			return req.getTarget() == null ? getCreateStartOutgoingDependencySupplier_4006Command(req) : getCreateCompleteIncomingDependencySupplier_4006Command(req);
		}
		if (UMLElementTypes.DependencyClient_4007 == req.getElementType()) {
			return req.getTarget() == null ? getCreateStartOutgoingDependencyClient_4007Command(req) : getCreateCompleteIncomingDependencyClient_4007Command(req);
		}
	 ...
	 * @generated
	 */
	protected Command getCreateStartOutgoingDependencySupplier_4006Command(CreateRelationshipRequest req) {
		EObject sourceEObject = req.getSource();
		if (false == sourceEObject instanceof Dependency) {
			return UnexecutableCommand.INSTANCE;
		}
		Dependency source = (Dependency) sourceEObject;
		if (!UMLBaseItemSemanticEditPolicy.LinkConstraints.canCreateDependencySupplier_4006(source, null)) {
			return UnexecutableCommand.INSTANCE;
		}
		return new Command() {
		};
	 ...
	 * @generated
	 */
	protected Command getCreateStartOutgoingDependencyClient_4007Command(CreateRelationshipRequest req) {
		EObject sourceEObject = req.getSource();
		if (false == sourceEObject instanceof Dependency) {
			return UnexecutableCommand.INSTANCE;
		}
		Dependency source = (Dependency) sourceEObject;
		if (!UMLBaseItemSemanticEditPolicy.LinkConstraints.canCreateDependencyClient_4007(source, null)) {
			return UnexecutableCommand.INSTANCE;
		}
		return new Command() {
		};
