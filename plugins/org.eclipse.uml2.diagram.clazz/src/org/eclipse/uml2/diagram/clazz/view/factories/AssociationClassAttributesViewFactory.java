 ...
 * @generated
 */
public class AssociationClassAttributesViewFactory extends BasicNodeViewFactory {
	...
	protected void decorateViewGen(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index, boolean persisted) {
		if (semanticHint == null) {
			semanticHint = UMLVisualIDRegistry.getType(AssociationClassAttributesEditPart.VISUAL_ID);
