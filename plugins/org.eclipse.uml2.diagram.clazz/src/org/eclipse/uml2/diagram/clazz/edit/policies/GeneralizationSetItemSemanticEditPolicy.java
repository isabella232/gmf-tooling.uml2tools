...
import org.eclipse.uml2.diagram.clazz.edit.commands.Generalization2TypeLinkCreateCommand;
...
public class GeneralizationSetItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator it = allEdges.iterator(); it.hasNext();) {
			...
			EditCommandRequestWrapper editCommandRequest = new EditCommandRequestWrapper(new DestroyElementRequest(((GeneralizationSetEditPart) getHost()).getEditingDomain(), req
	...
	protected Command getCreateRelationshipCommand(CreateRelationshipRequest req) {
		...
		if (UMLElementTypes.Generalization_4011 == req.getElementType()) {
			return req.getTarget() == null ? null : getCreateCompleteIncomingGeneralization_4011Command(req);
		}
	 ...
	 * @generated
	 */
	protected Command getCreateCompleteIncomingGeneralization_4011Command(CreateRelationshipRequest req) {
		EObject sourceEObject = req.getSource();
		EObject targetEObject = req.getTarget();
		if (false == sourceEObject instanceof Classifier || false == targetEObject instanceof GeneralizationSet) {
			return UnexecutableCommand.INSTANCE;
		}
		...
		return getMSLWrapper(new Generalization2TypeLinkCreateCommand(req, source, target));
	}
