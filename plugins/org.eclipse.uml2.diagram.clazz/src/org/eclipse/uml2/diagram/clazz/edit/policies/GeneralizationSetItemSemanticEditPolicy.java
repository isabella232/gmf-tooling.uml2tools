...
public class GeneralizationSetItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {
	...
	protected Command getCreateRelationshipCommand(CreateRelationshipRequest req) {
		...
		if (UMLElementTypes.Generalization_4011 == req.getElementType()) {
			return req.getTarget() == null ? null : getCreateCompleteIncomingGeneralization4011Command(req);
		}
	 ...
	 * @generated
	 */
	protected Command getCreateCompleteIncomingGeneralization4011Command(CreateRelationshipRequest req) {
		EObject sourceEObject = req.getSource();
		EObject targetEObject = req.getTarget();
