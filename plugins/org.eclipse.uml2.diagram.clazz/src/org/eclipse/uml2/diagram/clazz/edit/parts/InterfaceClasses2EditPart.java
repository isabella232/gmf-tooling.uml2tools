...
import org.eclipse.uml2.diagram.clazz.edit.policies.InterfaceClasses2CanonicalEditPolicy;
import org.eclipse.uml2.diagram.clazz.edit.policies.InterfaceClasses2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class InterfaceClasses2EditPart extends ListCompartmentEditPart implements IInsertableEditPart {
	 ...
	 * @generated
	 */
	public InterfaceClasses2EditPart(View view) {
		super(view);
	}
	...
	public String getCompartmentName() {
		return Messages.InterfaceClasses2EditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new InterfaceClasses2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE, new CreationEditPolicyWithCustomReparent(UMLVisualIDRegistry.TYPED_ADAPTER));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new InterfaceClasses2CanonicalEditPolicy());
