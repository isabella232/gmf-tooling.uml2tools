...
public class TerminatePseudostateEditPart extends AbstractBorderedShapeEditPart implements PrimaryShapeEditPart {
	...
	protected IFigure createNodeShape() {
		return primaryShape = new TerminateFigure();
	}
	...
	*/
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof PseudostateName8EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(PseudostateName8EditPart.VISUAL_ID));
	}
	 ...
	 * @generated
	 */
	public class TerminateFigure extends ScalablePolygonShape {
