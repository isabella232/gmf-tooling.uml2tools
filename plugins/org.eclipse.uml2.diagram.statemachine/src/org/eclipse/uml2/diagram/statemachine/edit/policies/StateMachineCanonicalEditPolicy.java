...
public class StateMachineCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.getStateMachine_2005SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		int visualID = UMLVisualIDRegistry.getVisualID(view);
		return visualID == StateMachine_RegionEditPart.VISUAL_ID || visualID == EntryPointPseudostateEditPart.VISUAL_ID || visualID == ExitPointPseudostateEditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.getStateMachine_2005SemanticChildren((View) getHost().getModel());
