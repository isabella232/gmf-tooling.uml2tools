...
public class UMLInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		try {
			...
			UMLDiagramEditorPlugin.getInstance().logError("Unable to load resource: " + domainModelURI, ex);
		}
		if (diagramRoot == null) {
		...
		wizard.setWindowTitle("Initialize new " + StateMachineEditPart.MODEL_ID + " diagram file");
