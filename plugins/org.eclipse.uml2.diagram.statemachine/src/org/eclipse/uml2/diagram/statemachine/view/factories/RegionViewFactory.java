...
public class RegionViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index, boolean persisted) {
		if (semanticHint == null) {
			semanticHint = UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.statemachine.edit.parts.RegionEditPart.VISUAL_ID);
		...
		getViewService().createNode(semanticAdapter, view, UMLVisualIDRegistry.getType(RegionSubverticesEditPart.VISUAL_ID), ViewUtil.APPEND, true, getPreferencesHint());
	}
