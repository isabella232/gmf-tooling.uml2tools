...
public class CompositeState_InternalActivitiesCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.getStateCompositeState_InternalActivities_7006SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.getStateCompositeState_InternalActivities_7006SemanticChildren((View) getHost().getModel());
