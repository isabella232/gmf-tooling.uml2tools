...
public class StateMachineStereotypeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.StateMachine_2005, getParserElement(),
					UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.statemachine.edit.parts.StateMachineStereotypeEditPart.VISUAL_ID));
		}
		return parser;
	}
