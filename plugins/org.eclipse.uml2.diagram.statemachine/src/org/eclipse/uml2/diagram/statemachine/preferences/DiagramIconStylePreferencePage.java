...
public class DiagramIconStylePreferencePage extends IconStylePreferencePage {
	...
	private void addAllCheckBoxes(Composite parent) {
		...
		addCheckBoxForVisualIds(parent, Messages.DiagramIconStylePreferencePage_label_for_Pseudostate, 5007);
		addCheckBoxForVisualIds(parent, Messages.DiagramIconStylePreferencePage_label_for_Region, 5026);
