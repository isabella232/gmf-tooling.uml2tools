 ...
 * @generated
 */
public class PseudostateName4EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.statemachine.edit.parts.PseudostateName4EditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public PseudostateName4EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Pseudostate_3007, getParserElement(),
					UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.statemachine.edit.parts.PseudostateName4EditPart.VISUAL_ID));
		}
		return parser;
	}
