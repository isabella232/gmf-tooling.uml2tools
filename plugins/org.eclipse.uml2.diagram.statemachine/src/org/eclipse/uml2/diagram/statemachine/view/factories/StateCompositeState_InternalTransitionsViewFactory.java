...
public class StateCompositeState_InternalTransitionsViewFactory extends BasicNodeViewFactory {
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index, boolean persisted) {
		if (semanticHint == null) {
			semanticHint = UMLVisualIDRegistry.getType(StateCompositeState_InternalTransitionsEditPart.VISUAL_ID);
