...
import org.eclipse.uml2.diagram.component.async.UMLComponentSynchronizationWizardPage;
...
public class UMLNewDiagramFileWizard extends Wizard {
	 ...
	 * @generated
	 */
	private UMLComponentSynchronizationWizardPage synchronizationPage;
	...
	private void createSynchronizationPage(TransactionalEditingDomain editingDomain) {
		synchronizationPage = new UMLComponentSynchronizationWizardPage("Select diagram synchronization scheme", editingDomain);
	...
	private void createFileCreationPage(URI domainModelURI) {
		...
		myFileCreationPage.setFileName(UMLDiagramEditorUtil.getUniqueFileName(filePath, fileName, "umlcomp")); //$NON-NLS-1$
		myFileCreationPage.setFileExtension("umlcomp"); //$NON-NLS-1$
	}
	...
	private static class DiagramRootElementSelectionPage extends ModelElementSelectionPage {
		...
		public IWizardPage getNextPage() {
			...
			if (nextPage instanceof WizardNewFileCreationPage) {
				...
				fileCreationPage.setFileName(UMLDiagramEditorUtil.getUniqueFileName(fileCreationPage.getContainerFullPath(), fileName, "umlcomp")); //$NON-NLS-1$
			}
			return nextPage;
		}
	}
