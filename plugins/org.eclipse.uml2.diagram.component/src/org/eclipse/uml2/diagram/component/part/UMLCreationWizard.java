...
public class UMLCreationWizard extends Wizard implements INewWizard {
	...
	public void addPages() {
		diagramModelFilePage = new UMLCreationWizardPage("DiagramModelFile", getSelection(), "umlcomponent_diagram"); //$NON-NLS-1$ //$NON-NLS-2$
		diagramModelFilePage.setTitle("Create UMLComponent Diagram");
		...
		domainModelFilePage.setTitle("Create UMLComponent Diagram");
