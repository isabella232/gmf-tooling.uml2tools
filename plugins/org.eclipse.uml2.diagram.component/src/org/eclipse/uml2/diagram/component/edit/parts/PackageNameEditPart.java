...
public class PackageNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Package_2005, getParserElement(),
					UMLVisualIDRegistry.getType(org.eclipse.uml2.diagram.component.edit.parts.PackageNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		if (initialChar != null && '<' == initialChar.charValue()) {
			Package2EditPart parent = (Package2EditPart) getParent();
			PackageStereo2EditPart stereoLabel = (PackageStereo2EditPart) parent.getChildBySemanticHint(UMLVisualIDRegistry.getType(PackageStereo2EditPart.VISUAL_ID));
			if (stereoLabel != null) {
