...
import org.eclipse.uml2.diagram.component.edit.policies.ArtifactContentsCanonicalEditPolicy;
import org.eclipse.uml2.diagram.component.edit.policies.ArtifactContentsItemSemanticEditPolicy;
...
public class ArtifactContentsEditPart extends ShapeCompartmentEditPart {
	 ...
	 * @generated
	 */
	public ArtifactContentsEditPart(View view) {
		super(view);
	}
	...
	public String getCompartmentName() {
		return Messages.ArtifactContentsEditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ArtifactContentsItemSemanticEditPolicy());
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new ArtifactContentsCanonicalEditPolicy());
