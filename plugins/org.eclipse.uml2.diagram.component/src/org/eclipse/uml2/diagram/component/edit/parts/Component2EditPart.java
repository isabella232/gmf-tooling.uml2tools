...
public class Component2EditPart extends AbstractBorderedShapeEditPart implements PrimaryShapeEditPart {
	...
	private List<? extends IUpdaterLinkDescriptor> getComponent_3001ContainedLinks() {
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateUnspecifiedTypeRequest) {
			...
			if (types.contains(UMLElementTypes.Component_3001)) {
				return getChildBySemanticHint(UMLVisualIDRegistry.getType(ComponentContents2EditPart.VISUAL_ID));
			}
