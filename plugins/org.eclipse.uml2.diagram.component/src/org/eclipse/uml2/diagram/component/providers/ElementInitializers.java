...
public class ElementInitializers {
		...
		try {
			UMLOCLFactory
					.getExpression(
							...
							UMLPackage.eINSTANCE.getComponent()).assignTo(UMLPackage.eINSTANCE.getNamedElement_Name(), instance);
		...
		try {
			UMLOCLFactory
					.getExpression(
							...
							UMLPackage.eINSTANCE.getArtifact()).assignTo(UMLPackage.eINSTANCE.getNamedElement_Name(), instance);
	...
	public static void init_Connector_4008(Connector instance) {
		try {
			UMLOCLFactory.getExpression("ConnectorKind::delegation", UMLPackage.eINSTANCE.getConnector()).assignTo(UMLPackage.eINSTANCE.getConnector_Kind(), instance);
