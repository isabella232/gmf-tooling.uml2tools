...
public class NewComponentDiagramAction implements IObjectActionDelegate, IEditorActionDelegate {
...
//		}
	...
	private boolean isEnabled() {
		...
		// use this condition until Semi-sync mode is supported
		mySelectedElements.size() == 1 && myDiagramRoot.equals(mySelectedElements.get(0));
	}
