...
public class TimingDLinkDescriptor extends TimingDNodeDescriptor implements IUpdaterLinkDescriptor {
	 ...
	 * @generated
	 */
	private TimingDLinkDescriptor(EObject source, EObject destination, EObject linkElement, int linkVID) {
	 ...
	 * @generated
	 */
	public TimingDLinkDescriptor(EObject source, EObject destination, IElementType elementType, int linkVID) {
	 ...
	 * @generated
	 */
	public TimingDLinkDescriptor(EObject source, EObject destination, EObject linkElement, IElementType elementType, int linkVID) {
