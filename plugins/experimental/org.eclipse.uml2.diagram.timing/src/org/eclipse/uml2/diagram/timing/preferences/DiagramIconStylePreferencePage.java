...
public class DiagramIconStylePreferencePage extends IconStylePreferencePage {
	...
	public DiagramIconStylePreferencePage() {
		setPreferenceStore(TimingDDiagramEditorPlugin.getInstance().getPreferenceStore());
	}
	...
	public boolean performOk() {
		super.performOk();
		TimingDElementTypes.refreshImageRegistry();
	...
	private void refreshDiagramEditors() {
		...
		for (int i = 0; i < editors.length; i++) {
			...
			if (editor != null && editor instanceof TimingDDiagramEditor) {
				((TimingDDiagramEditor) editor).refresh();
			}
		}
	}
