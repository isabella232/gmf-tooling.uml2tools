...
import org.eclipse.uml2.diagram.timing.edit.policies.TimingDTextSelectionEditPolicy;
...
public class DMessageDisplayNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(TimingDVisualIDRegistry.getType(org.eclipse.uml2.diagram.timing.edit.parts.DMessageDisplayNameEditPart.VISUAL_ID), new Point(0, 40));
	}

	/**
	 * @generated
	 */
	public DMessageDisplayNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new TimingDTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = TimingDParserProvider.getParser(TimingDElementTypes.DMessage_4002, getParserElement(), TimingDVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.timing.edit.parts.DMessageDisplayNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, TextDirectEditManager.getTextCellEditorClass(this), TimingDEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
