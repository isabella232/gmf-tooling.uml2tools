...
import org.eclipse.uml2.diagram.timing.parsers.AbstractParser;
...
public/*package-local?*/class Parser_0_0 extends AbstractParser {
	...
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(TimingDDiagramEditorPlugin.ID, IParserEditStatus.UNEDITABLE, NLS.bind(Messages.MessageFormatParser_InvalidInputError, new Integer(pos.getErrorIndex())));
		}
