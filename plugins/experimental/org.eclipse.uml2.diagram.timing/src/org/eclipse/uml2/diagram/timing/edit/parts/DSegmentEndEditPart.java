...
import org.eclipse.uml2.diagram.timing.edit.policies.DSegmentEndItemSemanticEditPolicy;
...
public class DSegmentEndEditPart extends ShapeNodeEditPart implements PrimaryShapeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DSegmentEndItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		MiddlePointFigure figure = new MiddlePointFigure();
	 ...
	 * @generated
	 */
	public MiddlePointFigure getPrimaryShape() {
		return (MiddlePointFigure) primaryShape;
	}
	...
	protected NodeFigure createNodePlate() {
		DefaultSizeNodeFigure result = new DefaultSizeNodeFigure(getMapMode().DPtoLP(16), getMapMode().DPtoLP(16));
		return result;
	}
	 ...
	 * @generated
	 */
	public class MiddlePointFigure extends Ellipse {

		/**
		 * @generated
		 */
		public MiddlePointFigure() {
			this.setBackgroundColor(ColorConstants.red);
			this.setPreferredSize(new Dimension(getMapMode().DPtoLP(16), getMapMode().DPtoLP(16)));
			this.setMaximumSize(new Dimension(getMapMode().DPtoLP(16), getMapMode().DPtoLP(16)));
