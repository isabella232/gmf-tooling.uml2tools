...
import org.eclipse.uml2.diagram.timing.edit.parts.TimingDEditPartFactory;
...
public class TimingDEditPartProvider extends AbstractEditPartProvider {
	 ...
	 * @generated
	 */
	public TimingDEditPartProvider() {
		setFactory(new TimingDEditPartFactory());
	...
	public synchronized boolean provides(IOperation operation) {
		if (operation instanceof CreateGraphicEditPartOperation) {
			...
			if (!DFrameContainerEditPart.MODEL_ID.equals(TimingDVisualIDRegistry.getModelID(view))) {
				return false;
			}
