...
public class DIntervalDurationEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(TimingDVisualIDRegistry.getType(org.eclipse.uml2.diagram.timing.edit.parts.DIntervalDurationEditPart.VISUAL_ID), new Point(0, -10));
	}

	/**
	 * @generated
	 */
	public DIntervalDurationEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = TimingDParserProvider.getParser(TimingDElementTypes.DInterval_4003, getParserElement(), TimingDVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.timing.edit.parts.DIntervalDurationEditPart.VISUAL_ID));
		}
		return parser;
	}
