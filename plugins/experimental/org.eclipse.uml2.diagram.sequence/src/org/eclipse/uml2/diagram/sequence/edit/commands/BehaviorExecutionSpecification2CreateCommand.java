 ...
 * @generated NOT
 */
public class BehaviorExecutionSpecification2CreateCommand extends AbstractCreateFragmentCommand {

	/**
	 * @generated
	 */
	public BehaviorExecutionSpecification2CreateCommand(CreateElementRequest req) {
		super(req);
	}
