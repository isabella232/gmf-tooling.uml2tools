...
public class UMLOCLFactory {
	...
	protected UMLOCLFactory() {
		this.expressions = new UMLAbstractExpression[34];
	}
	...
	public static UMLAbstractExpression getExpression(int index, EClassifier context, Map<String, EClassifier> environment) {
		...
		if (cached.expressions[index] == null) {
			final String[] exprBodies = new String[] {
					...
					"not self.oclIsKindOf(uml::Port)", //$NON-NLS-1$
					...
					"not oclIsKindOf(uml::Port)", //$NON-NLS-1$
					...
					"not self.oclIsKindOf(uml::Usage) and not self.oclIsKindOf(uml::InterfaceRealization)", //$NON-NLS-1$
					"self.supplier->forAll(e|e.oclIsKindOf(uml::Interface))", //$NON-NLS-1$
					"self.oclIsKindOf(uml::Interface)", //$NON-NLS-1$
					"self.supplier->forAll(e|e.oclIsKindOf(uml::Interface)) and self.client->forAll(e|(not e.oclIsKindOf(uml::Port)) and e.oclIsKindOf(uml::Classifier))", //$NON-NLS-1$
					"(not self.oclIsKindOf(uml::Port)) and self.oclIsKindOf(uml::Classifier)", //$NON-NLS-1$
					"self.oclIsKindOf(uml::Interface)", //$NON-NLS-1$
					"self.oclIsKindOf(uml::Port)", //$NON-NLS-1$
					"self.oclIsKindOf(uml::Port)", //$NON-NLS-1$
					"self.value->exists(v : ValueSpecification | v.oclIsKindOf(InstanceValue) and not v.oclAsType(InstanceValue).oclIsUndefined())", //$NON-NLS-1$
