...
public class PortRequiredReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientSourceGen() {
		...
		return UMLBaseItemSemanticEditPolicy.getLinkConstraints().canExistPortRequired_4014(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTargetGen() {
		...
		return UMLBaseItemSemanticEditPolicy.getLinkConstraints().canExistPortRequired_4014(getOldSource(), getNewTarget());
	}
