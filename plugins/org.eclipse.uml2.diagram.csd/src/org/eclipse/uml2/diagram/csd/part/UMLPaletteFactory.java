...
public class UMLPaletteFactory {
	...
	private PaletteContainer createLinks3Group() {
		...
		paletteContainer.add(createDependency8Group());
		return paletteContainer;
	}
	 ...
	 * @generated
	 */
	private PaletteContainer createDependency8Group() {
		PaletteGroup paletteContainer = new PaletteGroup(Messages.Dependency8Group_title);
		paletteContainer.setId("createDependency8Group"); //$NON-NLS-1$
		paletteContainer.setDescription(Messages.Dependency8Group_desc);
	...
	private ToolEntry createDependency1CreationTool() {
		...
		entry.setSmallIcon(UMLElementTypes.getImageDescriptor(UMLElementTypes.Dependency_4017));
