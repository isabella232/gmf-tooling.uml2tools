		...
		try {
			UMLOCLFactory
					.getExpression(
							...
							UMLPackage.eINSTANCE.getCollaboration()).assignTo(UMLPackage.eINSTANCE.getNamedElement_Name(), instance);
		...
		try {
			UMLOCLFactory
					.getExpression(
							...
							UMLPackage.eINSTANCE.getCollaborationUse()).assignTo(UMLPackage.eINSTANCE.getNamedElement_Name(), instance);
