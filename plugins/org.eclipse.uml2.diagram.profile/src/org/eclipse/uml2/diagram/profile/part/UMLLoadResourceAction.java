...
public class UMLLoadResourceAction implements IObjectActionDelegate {
	 ...
	 * @generated
	 */
	private ProfileEditPart mySelectedElement;
	...
	public void selectionChanged(IAction action, ISelection selection) {
		...
		if (selection instanceof IStructuredSelection) {
			...
			if (structuredSelection.size() == 1 && structuredSelection.getFirstElement() instanceof ProfileEditPart) {
				mySelectedElement = (ProfileEditPart) structuredSelection.getFirstElement();
			}
		}
