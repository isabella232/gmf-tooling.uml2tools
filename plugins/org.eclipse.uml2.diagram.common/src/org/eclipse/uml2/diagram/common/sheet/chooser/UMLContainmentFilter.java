...
public class UMLContainmentFilter extends ViewerFilter {
	...
	public static MetaclassContainmentFilter getWithoutTemplatesInstance() {
		if (TEMPLATE_EXCLUDED == null) {
			...
			List<EReference> templateRelated = Arrays.asList(new EReference[] { UML.getTemplateableElement_TemplateBinding(), UML.getTemplateSignature_OwnedParameter(),
					UML.getTemplateParameter_OwnedParameteredElement(), UML.getTemplateParameter_OwnedDefault(), });
