...
public class DValueLineDisplayNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DValueLineDisplayNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = TimingDParserProvider.getParser(TimingDElementTypes.DValueLine_3002, getParserElement(), TimingDVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.timing.edit.parts.DValueLineDisplayNameEditPart.VISUAL_ID));
		}
		return parser;
	}
