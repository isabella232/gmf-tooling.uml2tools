package org.eclipse.uml2.diagram.timing.expressions;
...
public class TimingDOCLFactory {

	/**
	 * @generated
	 */
	private TimingDOCLFactory() {
	}

	/**
	 * @generated
	 */
	public static TimingDAbstractExpression getExpression(String body, EClassifier context, Map environment) {
	 ...
	 * @generated
	 */
	public static TimingDAbstractExpression getExpression(String body, EClassifier context) {
	 ...
	 * @generated
	 */
	private static class Expression extends TimingDAbstractExpression {
	...
	public static OCLLookup.Expression getOCLLookupExpression(String body, EClassifier context) {
		final TimingDAbstractExpression expression = getExpression(body, context);
