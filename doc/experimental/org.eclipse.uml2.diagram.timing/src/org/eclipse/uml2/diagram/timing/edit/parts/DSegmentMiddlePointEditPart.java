...
public class DSegmentMiddlePointEditPart extends ShapeNodeEditPart implements PrimaryShapeEditPart {
	...
	protected NodeFigure createNodePlate() {
		DefaultSizeNodeFigure result = new DefaultSizeNodeFigure(getMapMode().DPtoLP(5), getMapMode().DPtoLP(5));
		return result;
	}
	...
	public class MiddlePointFigure extends Ellipse {
		...
		public MiddlePointFigure() {
			...
			this.setMaximumSize(new Dimension(getMapMode().DPtoLP(5), getMapMode().DPtoLP(5)));
			this.setMinimumSize(new Dimension(getMapMode().DPtoLP(5), getMapMode().DPtoLP(5)));
		}
