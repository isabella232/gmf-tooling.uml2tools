...
public class DBlockDisplayNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DBlockDisplayNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = TimingDParserProvider.getParser(TimingDElementTypes.DBlock_3001, getParserElement(), TimingDVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.timing.edit.parts.DBlockDisplayNameEditPart.VISUAL_ID));
		}
		return parser;
	}
