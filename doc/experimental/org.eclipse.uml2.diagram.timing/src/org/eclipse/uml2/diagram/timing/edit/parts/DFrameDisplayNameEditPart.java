...
public class DFrameDisplayNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DFrameDisplayNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = TimingDParserProvider.getParser(TimingDElementTypes.DFrame_2001, getParserElement(), TimingDVisualIDRegistry
					.getType(org.eclipse.uml2.diagram.timing.edit.parts.DFrameDisplayNameEditPart.VISUAL_ID));
		}
		return parser;
	}
