...
public class CreationToolTest extends org.eclipse.uml2.diagram.common.tests.CreationToolTest {
	...
	public void test_objectNodesCreation() {
		...
		flushEventQueue();
		Rectangle activityBounds = activityEditPart.getFigure().getBounds();
		IGraphicalEditPart activitySubverticesEditPart = 
			activityEditPart.getChildBySemanticHint(UMLVisualIDRegistry.getType(ActivitySubverticesEditPart.VISUAL_ID));
		...
		IGraphicalEditPart centralBufferNodeEditPart = 
			activitySubverticesEditPart.getChildBySemanticHint(UMLVisualIDRegistry.getType(CentralBufferNodeEditPart.VISUAL_ID));
		...
		IGraphicalEditPart dataStoreNodeEditPart = 
			activitySubverticesEditPart.getChildBySemanticHint(UMLVisualIDRegistry.getType(DataStoreNodeEditPart.VISUAL_ID));
	...
	public void test_controlNodesCreation() {
		...
		IGraphicalEditPart initialNodeEditPart = 
			activitySubverticesEditPart.getChildBySemanticHint(UMLVisualIDRegistry.getType(InitialNodeEditPart.VISUAL_ID));
		...
		IGraphicalEditPart finalNodeEditPart = 
			activitySubverticesEditPart.getChildBySemanticHint(UMLVisualIDRegistry.getType(ActivityFinalNodeEditPart.VISUAL_ID));
		...
		IGraphicalEditPart flowFinalNodeEditPart = 
			activitySubverticesEditPart.getChildBySemanticHint(UMLVisualIDRegistry.getType(FlowFinalNodeEditPart.VISUAL_ID));
		...
		IGraphicalEditPart mergeNodeEditPart = 
			activitySubverticesEditPart.getChildBySemanticHint(UMLVisualIDRegistry.getType(MergeNodeEditPart.VISUAL_ID));
		...
		IGraphicalEditPart decisionNodeEditPart = 
			activitySubverticesEditPart.getChildBySemanticHint(UMLVisualIDRegistry.getType(DecisionNodeEditPart.VISUAL_ID));
		...
		IGraphicalEditPart forkNodeEditPart = 
			activitySubverticesEditPart.getChildBySemanticHint(UMLVisualIDRegistry.getType(ForkNodeEditPart.VISUAL_ID));
		...
		IGraphicalEditPart joinNodeEditPart = 
			activitySubverticesEditPart.getChildBySemanticHint(UMLVisualIDRegistry.getType(JoinNodeEditPart.VISUAL_ID));
	...
	public void test_actionsCreation() {
		...
		IGraphicalEditPart acceptEventActionEditPart = 
			activitySubverticesEditPart.getChildBySemanticHint(UMLVisualIDRegistry.getType(AcceptEventActionEditPart.VISUAL_ID));
		...
		IGraphicalEditPart addFeatureActionEditPart = 
			activitySubverticesEditPart.getChildBySemanticHint(UMLVisualIDRegistry.getType(AddStructuralFeatureValueActionEditPart.VISUAL_ID));
		...
		IGraphicalEditPart callBehaviorActionEditPart = 
			activitySubverticesEditPart.getChildBySemanticHint(UMLVisualIDRegistry.getType(CallBehaviorActionEditPart.VISUAL_ID));
		...
		IGraphicalEditPart callOperationActionEditPart = 
			activitySubverticesEditPart.getChildBySemanticHint(UMLVisualIDRegistry.getType(CallOperationActionEditPart.VISUAL_ID));
		...
		IGraphicalEditPart createObjectActionEditPart = 
			activitySubverticesEditPart.getChildBySemanticHint(UMLVisualIDRegistry.getType(CreateObjectActionEditPart.VISUAL_ID));
		...
		IGraphicalEditPart opaqueActionEditPart = 
			activitySubverticesEditPart.getChildBySemanticHint(UMLVisualIDRegistry.getType(OpaqueActionEditPart.VISUAL_ID));
		...
		IGraphicalEditPart sendSignalActionEditPart = 
			activitySubverticesEditPart.getChildBySemanticHint(UMLVisualIDRegistry.getType(SendSignalActionEditPart.VISUAL_ID));
