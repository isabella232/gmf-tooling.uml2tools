...
public class InitClassDiagramFacade extends UMLInitDiagramFacade {
	...
	public InitClassDiagramFacade(IFile modelFile, IFile diagramFile) throws ExecutionException, IOException, CoreException {
